...
function Partners() {
  return (
    <div className="__partners-list">
        <a href="/" className="__partner-link"><DatabizLogo/></a>
        <a href="/" className="__partner-link"><AudiophileLogo/></a>
        <a href="/" className="__partner-link"><MeetLogo/></a>
        <a href="/" className="__partner-link"><MakerLogo/></a>
    </div>
  )
}
